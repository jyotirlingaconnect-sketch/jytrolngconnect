...
export function JourneyOverview() {
  ...
  return (
    <section className="py-16 md:py-20 bg-transparent relative z-20">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <motion.div
          ...
          className="max-w-4xl mx-auto mb-16 p-6 md:p-10 rounded-[2.5rem] bg-white/5 backdrop-blur-xl border border-white/10 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.3)] text-center relative overflow-hidden"
        >
          ...
          <motion.div 
            ...
            className="inline-flex items-center justify-center space-x-2 bg-white/10 backdrop-blur-md border border-white/20 px-6 py-2.5 rounded-full mb-8 shadow-xl cursor-default"
          >
          ...
          <h2 className="text-4xl md:text-6xl lg:text-7xl font-display font-bold text-white mb-8 drop-shadow-2xl leading-tight">
          ...
          <p className="text-lg md:text-xl text-white/90 leading-relaxed max-w-2xl mx-auto font-light drop-shadow-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 relative z-10">
            {steps.map((step, index) => (
              <motion.div
                ...
                className="group relative flex md:flex-col items-center md:text-center gap-6 p-8 rounded-[2rem] bg-white/5 backdrop-blur-xl border border-white/10 shadow-[0_20px_40px_-10px_rgba(0,0,0,0.3)] transition-all duration-300 hover:bg-white/10 hover:border-white/20 hover:shadow-[0_30px_60px_-15px_rgba(255,255,255,0.2)]"
              >
                {/* Floating Glass Icon */}
                <div className="relative">
                  ...
                  {/* Icon container */}
                  <div className="relative w-20 h-20 md:w-24 md:h-24 bg-black/20 backdrop-blur-2xl border border-white/20 shadow-inner rounded-full flex items-center justify-center z-10 group-hover:border-white/40 transition-colors duration-300">
                    <step.icon strokeWidth={1.5} className="w-10 h-10 md:w-12 md:h-12 text-white drop-shadow-md group-hover:scale-110 transition-transform duration-300" />
                  </div>
                </div>

                <div className="flex-1 md:mt-8 w-full flex flex-col items-start md:items-center">
                  <div className="inline-block px-4 py-1.5 bg-black/30 backdrop-blur-md border border-white/10 text-white text-xs font-bold uppercase tracking-widest rounded-full mb-5 shadow-sm group-hover:bg-black/40 transition-colors duration-300">
                    {step.time}
                  </div>
                  <h3 className="text-2xl lg:text-3xl font-display font-bold text-white mb-3 drop-shadow-md">{step.title}</h3>
                  <p className="text-white/80 font-light leading-relaxed text-sm lg:text-base">{step.subtitle}</p>
                </div>
              </motion.div>
            ))}
          </div>
