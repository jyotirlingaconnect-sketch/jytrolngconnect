  ...
  return (
    <div className="container mx-auto px-4 md:px-6 relative z-30">
      ...
      >
        ...
        {/* Inner Card (Glass) */}
        <div className="relative z-10 bg-white/5 backdrop-blur-2xl rounded-[2.4rem] p-10 md:p-16 lg:p-20 text-center shadow-[0_30px_60px_rgba(0,0,0,0.4),inset_0_1px_0_rgba(255,255,255,0.2)] h-full w-full">
          ...
          <div className="relative z-20">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-white mb-6 leading-tight drop-shadow-xl tracking-tight">
            ...
            <p className="text-lg md:text-xl text-white/90 mb-12 max-w-2xl mx-auto leading-relaxed font-light tracking-wide drop-shadow-md">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              ...
              <Link
                href="/booking"
                className="group relative flex items-center justify-center gap-3 px-10 py-5 bg-gradient-to-r from-[#D4AF6A] to-[#F5D08B] text-ink font-bold rounded-full overflow-hidden w-full sm:w-auto shadow-[0_0_30px_rgba(212,175,106,0.3)] transition-all hover:scale-105 hover:shadow-[0_0_40px_rgba(212,175,106,0.5)]"
              >
              ...
              <a
                ...
                className="group relative flex items-center justify-center gap-3 px-10 py-5 bg-white/10 backdrop-blur-md border border-white/20 text-white font-bold rounded-full w-full sm:w-auto transition-all hover:bg-white/20 hover:border-white/40 hover:scale-105 shadow-lg"
              >
